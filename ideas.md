...
1. **Donation pop-up** — every so often, when the app opens, show a small pop-up
   ...
   blocking the app.
2. **Group expenses into sections** — e.g. everything spent on a trip to Brazil.
3. **Money in fixed-term deposits (plazos fijos) with interest rates?**
4. **How to handle money held in Mercado Pago, given it earns yield all the time?**
